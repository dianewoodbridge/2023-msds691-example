...
-------------------------------------------------------------------------
--Ex 5. Create the insert_epa_data() function to insert a row in a format of (date, source, poc, daily_mean_pm10_concentration, units, daily_aqi_value, site_name, daily_obs_count, percent_complete, aqs_parameter_code, aqs_parameter_desc, cbsa_code, cbsa_name, state_code, state, county_code, county, site_latitude, site_longitude) to the normalized tables (2NF).
-------------------------------------------------------------------------
...
CREATE FUNCTION insert_epa_data(date_val DATE,
	...
	site_id_val	INTEGER,
	poc_val	INTEGER, 
	daily_mean_pm10_concentration_val	INTEGER,
...
INSERT INTO epa_air_quality_full VALUES (date_val, site_id_val, poc_val, daily_mean_pm10_concentration_val, daily_aqi_value_val, daily_obs_count_val, percent_complete_val) ON CONFLICT DO NOTHING;
